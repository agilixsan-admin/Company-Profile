const translations = {
  en: {
    ...
    portfolio: {
      ...
      subtitle:
        "Explore our curated selection of high-performance IT solutions and digital ecosystems. Designed with structural clarity and engineered for scale.",
      ...
      project1Tag: "E-commerce",
      project1Title: "Nexus Trade Platform",
      project1Desc:
        "A high-frequency trading and e-commerce hybrid platform built for latency-sensitive transactions, featuring real-time data flow visualization.",

      project2Tag: "Corporate",
      project2Title: "Aegis Data Mesh",
      project2Desc: "Enterprise-grade secure data architecture.",

      project3Tag: "Startup",
      project3Title: "Veloce MVP",
      project3Desc:
        "Rapid prototyping and structural architecture for an AI-driven logistics startup. Built for extreme scalability.",

      project4Tag: "E-commerce",
      project4Title: "Lumina Cart",
      project4Desc:
        "Headless e-commerce solution integrating multiple payment gateways with a glassmorphic front-end experience.",
      project4Link: "View Case Study →",
    },
  ...
  id: {
    ...
    portfolio: {
      title: "Presisi yang",
      titleHighlight: "Tercerahkan",
      subtitle:
        "Jelajahi koleksi solusi IT berperforma tinggi dan ekosistem digital pilihan kami. Dirancang dengan kejelasan struktural dan direkayasa untuk skala.",
      ...
      project1Tag: "E-commerce",
      project1Title: "Platform Nexus Trade",
      project1Desc:
        "Platform hibrida perdagangan frekuensi tinggi dan e-commerce yang dibangun untuk transaksi sensitif latensi, menampilkan visualisasi aliran data real-time.",

      project2Tag: "Korporat",
      project2Title: "Aegis Data Mesh",
      project2Desc: "Arsitektur data aman tingkat enterprise.",

      project3Tag: "Startup",
      project3Title: "Veloce MVP",
      project3Desc:
        "Prototipe cepat dan arsitektur struktural untuk startup logistik berbasis AI. Dibangun untuk skalabilitas ekstrem.",

      project4Tag: "E-commerce",
      project4Title: "Lumina Cart",
      project4Desc:
        "Solusi e-commerce headless yang mengintegrasikan berbagai payment gateway dengan pengalaman front-end glassmorphic.",
      project4Link: "Lihat Studi Kasus →",
    },
